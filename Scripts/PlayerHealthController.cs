...
public class PlayerHealthController : MonoBehaviour
{
    ...
    public void DamagePlayer()
    {
        if (invincCount <= 0)
        {
            ...
            PlayerController.instance.bodySR.color = new Color(PlayerController.instance.bodySR.color.r, PlayerController.instance.bodySR.color.g, PlayerController.instance.bodySR.color.b, .3f);
